        ...
        <div class="flex items-center justify-between h-16">
                ...
                <div class="flex items-center gap-3 pl-3 border-l border-white/[0.06]">
                    ...
                    <div class="relative" id="userDropdown">
                        <button onclick="toggleDropdown('userDropdownMenu')" 
                            ...
                            <div class="text-left">
                                <p class="text-sm font-semibold text-white leading-none"><?= htmlspecialchars($currentUser['name'] ?? 'Pakar Medis') ?></p>
                                <p class="text-[10px] text-slate-500 mt-0.5"><?= htmlspecialchars($currentUser['email'] ?? 'pakar@simrs.id') ?></p>
                            </div>
                        ...
                        <div id="userDropdownMenu" 
                            ...
                            <div class="px-4 py-2.5 border-b border-white/[0.06]">
                                <p class="text-sm font-semibold text-white"><?= htmlspecialchars($currentUser['name'] ?? 'Pakar Medis') ?></p>
                                <p class="text-xs text-slate-500"><?= htmlspecialchars($currentUser['email'] ?? 'pakar@simrs.id') ?></p>
                            </div>
            ...
            <div class="md:hidden">
                <button onclick="toggleMobileMenu()" 
                        class="p-2 rounded-lg text-slate-400 hover:text-white hover:bg-white/5 sim-focus transition-all">
